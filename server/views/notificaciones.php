...
<body>
    ...
    <div class="nav">
        <ul>
            ...
            <li><a href="<?php echo $base_url; ?>/notificaciones" class="active">Notificaciones</a></li>
                ...
                <?php foreach ($notificaciones as $notif): ?>
                    <div class="notification-card <?php echo !$notif['leida'] ? 'unread' : ''; ?>" 
                        ...
                        <div class="notification-status">
                            ...
                            <?php if (!$notif['leida']): ?>
                                <button class="btn-mark-read" onclick="event.stopPropagation(); markAsRead(<?php echo $notif['id']; ?>)">
                                    Marcar como leída
                                </button>
                            <?php endif; ?>
                        </div>
